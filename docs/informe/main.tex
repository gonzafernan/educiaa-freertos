...
\begin{tabular}{|l|l|}
    \hline
    \multicolumn{2}{|c|}{\textbf{Motor PaP}} \\ \hline
    Posición & \begin{tabular}[c]{@{}l@{}}:S\{Id1\}D\{Dirección1\}A\{Ángulo 1 con tres dígitos\}\\ S\{Id2\}D\{Dirección2\}A\{Ángulo 2 con tres dígitos\}\\ S\{Id3\}D\{Dirección3\}A\{Ángulo 3 con tres dígitos\}\end{tabular} \\ \hline
    Velocidad & :S\{Id\}V\{Período en ms\} \\ \hline
    \multicolumn{2}{|c|}{\textbf{Servomotor}} \\ \hline
    Posición & :X\{Ángulo\} \\ \hline
\end{tabular}
\end{table}
